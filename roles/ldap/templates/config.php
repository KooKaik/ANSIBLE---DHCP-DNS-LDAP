...
$config->custom->session['blowfish'] = 'e150811b0559ce84e0c7b4243e22c5ee';  # Autogenerated for srv-ldap01.domain.lan
...
$servers->setValue('server','name','Serveur LDAP');
...
// $servers->setValue('server','base',array('dc=domain,dc=lan'));
...
// $servers->setValue('login','bind_id','');
   $servers->setValue('login','bind_id','cn=ldapadm,dc=domain,dc=lan');
